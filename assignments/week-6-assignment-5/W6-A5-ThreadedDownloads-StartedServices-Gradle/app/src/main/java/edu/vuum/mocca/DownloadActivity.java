...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            Intent serviceIntent = DownloadIntentService.makeIntent(getBaseContext(), handler, getUrlString());
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
            Intent serviceThreadPool = ThreadPoolDownloadService.makeIntent(getBaseContext(), handler, getUrlString());
            startService(serviceThreadPool);
